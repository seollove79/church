...
<section class="section sermon" id="sermon">
	<div class="container">
		...
		<div class="sermon-details">
			<h3 class="sermon-title">다윗의 무모한 도전 (사무엘상 17:41-49)</h3>
			<p class="sermon-meta">설교자: 윤찬영 목사 / 설교일: 2025-09-21</p>
			<div class="sermon-actions">
				<button class="action-btn primary" on:click={() => window.open('https://www.youtube.com/watch?v=asua2ullGnc', '_blank')}>설교말씀보기</button>
